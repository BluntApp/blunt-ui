  ...
  initWizard: function () {
    ...
    var $validator = $('.card-wizard form').validate({
      ...
      highlight: function (element) {
        $(element).closest('.input-group').removeClass('has-success').addClass(
            'has-danger');
      },
      success: function (element) {
        $(element).closest('.input-group').removeClass('has-danger').addClass(
            'has-success');
      }
    });
    ...
    function refreshAnimation($wizard, index) {
      ...
      $('.moving-tab').css({
        'transform': 'translate3d(' + move_distance + 'px, ' + vertical_level
            + 'px, 0)',
      ...
      data: {
        ...
        datasets: [

          {
            ...
            borderWidth: 8,
            data: [100, 120, 80, 100, 90, 130, 110, 100, 80, 110, 130, 140, 130,
          ...
          },
          {
            ...
            borderWidth: 8,
            data: [80, 140, 50, 120, 50, 150, 60, 130, 50, 130, 150, 100, 110,
              80, 140, 50, 140, 50, 110, 150],
          }
        ]
      },
      options: {
    ...
    Chart.pluginService.register({
      beforeDraw: function (chart) {
        if (chart.config.options.elements.center) {
          ...
          var sidePaddingCalculated = (sidePadding / 100) * (chart.innerRadius
              * 2)
